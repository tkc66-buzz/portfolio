...
- Hero + Menu + Profile/Writing/Activities/Skills/Contact sections (single-page) composed via `src/components/*`
...
- Update the copy/data in `src/content/portfolio.ts` (profile/writing/activities/skills/contact).
